...
class M365Provider(Provider):
    ...
    def setup_identity(
        ...
        Args:
            ...
            cert_auth (bool): Flag indicating if certificate authentication is used.
            client_id (str): The M365 client ID.
        ...
        async def get_m365_identity(identity):
            ...
            if cert_auth:
                ...
                identity.identity_id = (
                    getenv("AZURE_APP_ID") or "Unknown application id"
                )
            elif sp_env_auth:
                identity.identity_type = "Service Principal"
                identity.identity_id = (
                    getenv("AZURE_CLIENT_ID") or "Unknown service principal id"
                )
            elif env_auth:
